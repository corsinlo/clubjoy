...
import { INQUIRY_PROCESS_NAME, FREE_BOOKING_PROCESS_NAME, BOOKING_PROCESS_NAME, PURCHASE_PROCESS_NAME, resolveLatestProcessName } from '../../transactions/transaction';
...
const EnhancedCheckoutPage = props => {
  ...
  useEffect(() => {
    ...
    if (getProcessName(data) === BOOKING_PROCESS_NAME || getProcessName(data) === PURCHASE_PROCESS_NAME){
